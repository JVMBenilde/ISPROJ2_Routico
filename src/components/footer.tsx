        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="text-black mb-4">
            ...
            <ul className="text-black space-y-2">
              <li>
                <Link to="/support" className="text-black hover:text-white transition">
                  Contact Support
                </Link>
              </li>
              <li>
                <Link to="/about-us" className="text-black hover:text-white transition">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-black hover:text-white transition">
                  Delivery Services
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-black hover:text-white transition">
                  Terms & Conditions
                </Link>
              </li> 
            </ul>
